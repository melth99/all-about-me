...
function App() {
 ...
 const league = {
  ...
  const gitCentral = {
    title: "Git Central",
    description: "A full-stack forum platform where users can create, discuss, and engage with topics via a forum. It provides a centralized platform to view, update, and delete repositories, as well as to create new ones.",
    bullets: ["Technologies: React, Node.js, MongoDB, Express, JSON Web Tokens"],
    imgs: [],
    links: []
  }
  return (
